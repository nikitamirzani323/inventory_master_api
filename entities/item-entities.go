...
type Model_cateitem struct {
	Cateitem_id         int    `json:"item_id"`
	Cateitem_name       string `json:"item_name"`
	Cateitem_status     string `json:"item_status"`
	Cateitem_status_css string `json:"item_status_css"`
	Cateitem_create     string `json:"item_create"`
	Cateitem_update     string `json:"item_update"`
}
